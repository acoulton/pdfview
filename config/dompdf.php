...
/*
 * Configuration options for DOMPDF. The values here should track the dompdf
 * defaults and can be overridden either by config files higher in the filesystem,
 * or by calling View_PDF::set_dompdf_option
 */
...
return array(
	...
	/**
		...
		* [!!] Cannot be defined through pdfview!
		*/
	...
	/**
		...
		* *Please note the trailing slash.*
		*/
		View_PDF::DOMPDF_FONT_DIR => $dompdf_dir . "/lib/fonts/",
		...
		*/
		View_PDF::DOMPDF_FONT_CACHE => Kohana::$cache_dir.'dompdf',
		...
		*/
		View_PDF::DOMPDF_TEMP_DIR => sys_get_temp_dir(),
		...
		*/
		View_PDF::DOMPDF_PDF_BACKEND => 'CPDF',
		...
		*/
		View_PDF::DOMPDF_PDFLIB_LICENSE => "your license key here",
		...
		*/
		View_PDF::DOMPDF_DEFAULT_MEDIA_TYPE => "screen",
		...
		*/
		View_PDF::DOMPDF_DEFAULT_PAPER_SIZE => "letter",
		...
		* @var string
		*/
		View_PDF::DOMPDF_DEFAULT_FONT => "serif",
		...
		* @var bool
		*/
		View_PDF::DOMPDF_ENABLE_PHP => FALSE,
		...
		* @var bool
		*/
		View_PDF::DOMPDF_ENABLE_JAVASCRIPT => TRUE,
		...
		* @var bool
		*/
		View_PDF::DOMPDF_ENABLE_REMOTE => FALSE,
	
		/**
		* The debug output log
		* @var string
		*/
		View_PDF::DOMPDF_LOG_OUTPUT_FILE => Kohana::$cache_dir.'dompdf/log.htm',
		...
		*/
		View_PDF::DOMPDF_ENABLE_HTML5PARSER => FALSE,
	),
);
